package com.dizzle.blocks;

import java.util.Random;

import com.dizzle.main.EnumMaterialTypes;
import com.dizzle.main.MysticTabs;
...
public class BlockMod extends Block {
	...
	public BlockMod(String name, String finalName, float hardness) {
		this(EnumMaterialTypes.STONE, name, finalName, hardness, MysticTabs.blocks);
	}

	public BlockMod(String name, String finalName) {
		this(EnumMaterialTypes.STONE, name, finalName, 2.0F, MysticTabs.blocks);
	}

	public BlockMod(EnumMaterialTypes type, String name, String finalName, float hardness) {
		this(type, name, finalName, hardness, MysticTabs.blocks);
	}
	...
	public BlockMod(String name, String finalName, boolean breakable) {
		this(name, finalName, breakable, MysticTabs.blocks);
	}
